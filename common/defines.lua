...
NMilitary = {
	...
	LIGHT_CAVALRY_PHASE_PURSUE_ATTACK = 7,
...
NAI =
{
	...
	CRUSADE_CREATION_MONTH_DELAY = 1200,					-- Months from the end of one Crusade before the AI will call a new one
