...
NDiplomacy = {
	...
	DEFENSIVE_PACT_MAX_RANGE = 100,								-- At 100% threat characters are able to join defensive pacts against targets of this distance
	DEFENSIVE_PACT_MAX_RANGE_SAME_GROUP = 100,					-- At 100% threat characters are able to join defensive pacts against targets of this distance
...
NEconomy = {
	...
	LOOTER_ARMY_MAINT_MULT = 0.3,					-- Armies set to 'Looter' have lower maintenance (only applies while the Realm is at peace!)
...
NMilitary = {
	MORALE_COLLAPSE_THRESHOLD = 0.10,				-- Threshold before unit runs away
	MORALELOSS_FACTOR = 2.0,						-- Affects the morale loss rate in combats (higher gives bigger losses)
	...
	HOLDING_LEVY_SIZE_OWNER_MARTIAL_BASE = 1.0,
	HOLDING_LEVY_SIZE_OWNER_MARTIAL_MULT = 0.015,	-- Levy size modifier: Each point of the holding owner's Martial skill is multiplied with this and added to HOLDING_LEVY_SIZE_OWNER_MARTIAL_BASE
	...
	BATTLE_WARSCORE_WORTH = 65,						-- Warscore from battles are multiplied with this value
	...
	TOTAL_OCCUPATION_SCALE = 0.9,					-- The % of occupation which gives you 100% warscore
	...
	WAR_CONTRIBUTION_OCCUPATION_PER_DAY = 5,		-- Occupying a Holding gives this Contribution score per day
	WAR_CONTRIBUTION_PROVINCE_WITHOUT_SETTLEMENT_OCCUPATION_PER_DAY = 2, -- Occupying a province without settlements gives this score per day, multiplied with the number of empty holdings
	...
	WAR_CONTRIBUTION_THEOCRACY_GHW_MULT = 0.30,	-- Holy Orders and other theocracies (notably the Pope) get less war contribution score during Great Holy Wars
	...
	LOOT_BUILDING_MULTIPLIER = 0.003,				-- Extra gold looted from raided holdings, from buildings (LOOT_BUILDING_MULTIPLIER * building built cost)
	...
	PIKEMEN_PHASE_SKIRMISH_ATTACK = 0.25,
	PIKEMEN_PHASE_MELEE_ATTACK = 5,
	PIKEMEN_PHASE_PURSUE_ATTACK = 2,
	...
	LIGHT_CAVALRY_PHASE_PURSUE_ATTACK = 8,
	...
	ARCHERS_PHASE_PURSUE_DEFENSE = 1.5,
